/* =========================================================
   UniLost — SVG Icon Library
   All icons returned as inline SVG strings.
   Usage: document.innerHTML = icon("search", 18)
   ========================================================= */
...
const ICONS = {
  ...
  download:   `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="8 17 12 21 16 17"/><line x1="12" y1="12" x2="12" y2="21"/><path d="M20.88 18.09A5 5 0 0 0 18 9h-1.26A8 8 0 1 0 3 16.36"/></svg>`,
...
function icon(name, size = 18, color = "currentColor") {
  ...
  if (!svg) return "";
  return svg
    .replace('<svg ', `<svg width="${size}" height="${size}" style="color:${color};flex-shrink:0;vertical-align:middle;" `);
}
