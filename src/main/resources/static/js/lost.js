/* =========================================================
   UniLost – lost.js
   Handles the "Report Lost Item" form.
   ========================================================= */
...
(function () {
  ...
  form.addEventListener("submit", async function (e) {
    ...
    try {
      ...
      if (res.ok) {
        showAlert("success", "✅ Lost item reported! Redirecting…");
        form.reset();
        form.classList.remove("was-validated");
        resetImagePreview();
        setTimeout(() => (window.location.href = "lost-items.html"), 1400);
      } else {
